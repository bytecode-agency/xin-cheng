...
@section('content')
    ...
    <div class="dataAreaMain">
        <form action="{{ route('operation.save') }}" method="post" id="operation_form"
            ...
            <fieldset id="start_field" class="w-100 justify-content-start flex-wrap form-fields">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body d-flex flex-wrap">
                                        ...
                                        <div class="formAreahalf ">
                                            <label for="" class="form-label"> Does passholder need to set up company?
                                            </label>
                                        ...
                                        <div class="formAreahalf ">
                                            ...
                                            <input type="text" class="form-control" name="pass[0][pass_job_title]">
                                        </div>
                ...
                <div class="card formContentData border-0 p-4">
                    ...
                    <div class="text-center pt-4 " id="append_div_btn">
                        ...
                        <button type="button"  id="previous2"
                            class="btn btn-danger previous-step cancelBtn saveBtn">Back</button>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
                ...
                $("#passholder_section .pass_design").last().append(`<div id="dynamicAddRemove"
                     ...
                     <div class="accordion-body d-flex flex-wrap">
                        ...
                        <div class="formAreahalf ">
                            ...
                            <select name="pass[` + p + `][pass_app_sts]">
                        ...
                        <div class="formAreahalf ">
                            ...
                            <select name="pass[` + p + `][rel_pass_hol]" >
                                <option value="">Please select relationship with pass holder</option>
                                <option value="Self">Self</option>
                                                <option value="parents">parents</option>
                                                <option value="spouse">spouse</option>
                                                <option value="children">children</option>
                            ...
                            <div class="card formContentData border-0 p-4">
                                ...
                                <div id="fo_pr" class="pr">
                                    ...
                                    <div class="formAreahalf ">
                                        ...
                                        <select name="pr[` + (btn_click_p - 1) + `][0][application_sts]" id="">
                                            <option value="" selected >Please select
                                            </option>
                                            <option value="Pending">Pending</option>
                                        <option value="Approved">Approved</option>
            ...
            $('.add_company').click(function() {
                ...
                $('#appended_company_div').last().append(
                    ` <div id="fo_company"><div class="w-100 d-flex justify-content-start flex-wrap form-fields company_design parent_field2` +
                    c + `"> <div class="cross"><span class="remove-input" data-id=".parent_field2` + c + `">x</span></div>
                    <div class="accordion-item">
                    ...
                    `</label>
                                <input type="text" name="cmp[` + c + `][fo_company]" id="fo_compnay" class="form-control"
                                    value="">
                            </div>
           ...
           alert('yes');
                        ...
                        $(".FO_shareholder_extra .each_shareholder").last().append(`
                            ...
                            (also - 1) + `][job_title]">
                                  ...
                                  <div class="formAreahalf ">
                                      ...
                                      <input type="text" class="form-control" name="share[` + (btn_click - 1) +
                            `][` + (also - 1) + `][month_sal]" value="` + p_month_sal[key] + `">
                                  </div>
            ...
            $('body').on('click', '.next3', function() {
                ...
                <div class="full_div">
                        ...
                        <div class="formAreahalf">
                            <label for="" class="form-label">Financial Institution Name 1</label>
                        ...
                        <div class="formAreahalf ">
                            ...
                            <select name="fi[` + (btn_click - 1) + `][0][acc_type]" id="">
                                <option value="" selected >Please select
                                </option>
                        ...
                        <div class="formAreahalf ">
                            ...
                            <select name="fi[` + (btn_click - 1) + `][0][acc_opn_sts]" id="">
                                <option value="" selected >Please select
                                </option>
                                <option value="Pending">Pending</option>
                                <option value="Approved">Approved</option>
                        ...
                        <div class="formAreahalf ">
                            ...
                            <select name="fi[` + (btn_click - 1) + `][0][acc_crt_sts]" id="">
                                <option value="" selected >Please select
                                </option>
                                <option value="Pending">Pending</option>
                                <option value="Approved">Approved</option>
                ...
                $(this).parents('fieldset').find('.appended_shareholder_div').append(
                    ...
                    (sh_no - 1) + `][eqt_per]">%
                                  ...
                                  <div class="formAreahalf ">
                                      <label for="clienttype" class="form-label">Passport Reminder Trigger
                                          Frequency</label>
                                          <div class="select_box"><span class="every">Every</span><span
                                                class="select"><select name="share[` + (arr_id - 1) + `][` + (sh_no - 1) + `][passport_rem_fre]" id="renewlfre">
                                          <option value="">Please select</option>
                                          <option value="Day">Day</option>
                                <option value="3 Days">3 Days</option>
                                <option value="Week">Week</option>
                    ...
                    (sh_no - 1) + `][month_sal]">
                                  ...
                                  <div class="formAreahalf ">
                                      <label for="clienttype" class="form-label"> Relationship With Share Holder
                                          1</label>
                                      <select name="share[` + (arr_id - 1) + `][` + (sh_no - 1) + `][rel_share_hol]" id="renewlrem">
                                          <option value="">Please select relationship with pass share
                                          </option>
                                          <option value="Self">Self</option>
                                      </select>
                ...
                $(this).parents('fieldset').find('.appended_financial_div').append(
                    `<div id="fo_financial" class="financial fi` + fi_no + `">\
                     <div class="w-100 d-flex justify-content-start flex-wrap form-fields company_design">\
                        ...
                        <div class="formAreahalf ">
                            <label for="" class="form-label">Account Type</label>
                            <select name="fi[` + (arr_id - 1) + `][` + fi_no + `][acc_type]" id="">
                                <option value="" selected >Please select
                                </option>
                                <option value="SGD">SGD</option>
                                <option value="USD">USD</option>
                        ...
                        <div class="formAreahalf ">
                            <label for="" class="form-label">Account Opening Status</label>
                            <select name="fi[` + (arr_id - 1) + `][` + fi_no + `][acc_opn_sts]" id="">
                                <option value="" selected >Please select
                                </option>
                                <option value="Pending">Pending</option>
                                <option value="Approved">Approved</option>
                        ...
                        <div class="formAreahalf ">
                            <label for="" class="form-label">Account Current Status</label>
                            <select name="fi[` + (arr_id - 1) + `][` + fi_no + `][acc_crt_sts]" id="">
                                <option value="" selected >Please select
                                </option>
                                <option value="Pending">Pending</option>
                                <option value="Approved">Approved</option>
                    ...
                    `<div id="fo_pr" class=" pr` + pr_no + `">\
                     <div class="w-100 d-flex justify-content-start flex-wrap form-fields company_design">\
                        ...
                        <div class="formAreahalf">
                                ...
                                <div class="formAreahalf ">
                                    <label for="" class="form-label">Pass Application Status</label>
                                    <select name="pr[` + (arr_id - 1) + `][` + pr_no + `][application_sts]" id="">
                                        <option value="" selected >Please select
                                        </option>
                                        <option value="Pending">Pending</option>
                                        <option value="Approved">Approved</option>
