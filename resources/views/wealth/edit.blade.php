                                ...
                                <div class="tab-inner-text d-flex flex-wrap">
                                    ...
                                    <div class="formAreahalf basic_data">
                                        <label for="pass_issuance_date" class="form-label">First Pass Issued Date (DD/MM/YYYY)</label>
                                            <input type="date" name="passholder[{{$passholder_key}}][first_pass_issue]"
                                            value="{{$passholder_item->first_pass_issue ?? ''}}"
                                            class="form-control" placeholder="dd/mm/yyyy">
                                    </div>
                                    <div class="formAreahalf basic_data">
                                                ...
                                                <div class="redemption_table_data">
                                                    <div class="formAreahalf r_table">
                                                        <label for="net_amount_val" class="form-label">Redemption
                                                            Date</label>
                <input type="date" name="business_redemption_date"min="<?php echo date("Y-m-d"); ?>" value="" class="form-control red_date" onkeydown="return false" />
                                                    </div>
                                                    <div class="formAreahalf r_table">
                                                        <label for="net_amount_val" class="form-label">Redemption
                                                            Amount</label>
