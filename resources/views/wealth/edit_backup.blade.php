    ...
    <div class="dataAreaMain edit_wealth">
                            ...
                            @if ($data->business_type == 'FO')
                                ...
                                <div class="tab-pane fade show active" id="nav-mas" role="tabpanel"
                                    ...
                                    <div id="mas_accordion" class="mas_related">
                                        ...
                                        <div id="mas_collapseOne" class="collapse" aria-labelledby="headingOne"
                                            ...
                                            <div class="tab-inner-text d-flex flex-wrap">
                                                ...
                                                <div class="formAreahalf basic_data">
                                                    ...
                                                    <select name="deck_submission" id="deck_submission"
                                                        ...
                                                        <option value="Progress"
                                                            {{ isset($wealth_mas->deck_submission) && $wealth_mas->deck_submission == 'Progress' ? 'selected' : '' }}>Progress</option>
                                                        <option value="Done"
                                                ...
                                                <div class="formAreahalf basic_data">
                                                    ...
                                                    <select name="reminder_notification" id="reminder_notification"
                                                        ...
                                                        <option value="60 days onwards til deadline"
                                                            {{ isset($wealth_mas->reminder_notification) && $wealth_mas->reminder_notification == '60 days onwards til deadline' ? 'selected' : '' }}>
                                                            60 days onwards til deadline</option>
                                                    </select>
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                ...
                                                <div class="formAreahalf basic_data">
                                                    <label for="trigger_fqy_rem" class="form-label">Trigger
                                ...
                                <input type="hidden" name="wealth_finance_id"
                                    value="@isset($wealthfinance->id) {{ $wealthfinance->id }} @endisset">
                                            ...
                                            <div class="formAreahalf basic_data">
                                                ...
                                                <select name="stakeholder_type" id="stakeholder_type"
                                                    ...
                                                    <option value="Fund CO."
                                                        {{ isset($wealthfinance->stakeholder_type) && $wealthfinance->stakeholder_type == 'Active' ? 'selected' : '' }}>
                                                        Fund CO.</option>
                                                    <option value="Management CO."
                                                        {{ isset($wealthfinance->stakeholder_type) && $wealthfinance->stakeholder_type == 'Management CO.' ? 'selected' : '' }}>
                                                        Management CO.</option>
                                                    <option value="Shareholder"
                                                        {{ isset($wealthfinance->stakeholder_type) && $wealthfinance->stakeholder_type == 'Shareholder' ? 'selected' : '' }}>
                                                        Shareholder</option>
                                                    <option value="Pass holder"
                                                        {{ isset($wealthfinance->stakeholder_type) && $wealthfinance->stakeholder_type == 'Pass holder' ? 'selected' : '' }}>
                                                        Pass holder</option>
                                                </select>
                                            </div>
                                            <div class="formAreahalf basic_data">
                                                ...
                                                <input type="text" name="financial_institution_name"
                                                    id="financial_institution_name"
                                                    value="@isset($wealthfinance->financial_institution_name) {{ $wealthfinance->financial_institution_name }} @endisset"
                                                    class="form-control">
                                            </div>
                                        ...
                                        <div id="financial_collapseOne" class="collapse" aria-labelledby="headingOne"
                                            ...
                                            <div class="tab-inner-text d-flex flex-wrap">
                                                <div class="formAreahalf basic_data">
                                                    ...
                                                    <input type="text" name="poc_name" id="poc_name"
                                                        value="@isset($wealthfinance->poc_name) {{ $wealthfinance->poc_name }} @endisset"
                                                        class="form-control">
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                    <label for="poc_contact_no" class="form-label">POC Contact
                                                        Number</label>
                                                    <input type="text" name="poc_contact_no" id="poc_contact_no"
                                                        value="@isset($wealthfinance->poc_contact_no){{ $wealthfinance->poc_contact_no }} @endisset"
                                                        class="form-control">
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                    <label for="poc_email" class="form-label">POC Email</label>
                                                    <input type="text" name="poc_email" id="poc_email"
                                                        value="@isset($wealthfinance->poc_email){{ $wealthfinance->poc_email }} @endisset"
                                                        class="form-control">
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                    <label for="application_submission" class="form-label">Application
                                                        Submission</label>
                                                    <select name="application_submission" id="application_submission"
                                                        class="js-example-responsive form-control">
                                                        <option value="" selected disabled>Choose application
                                                            submission
                                                        </option>
                                                        <option
                                                            value="Progress"{{ isset($wealthfinance->application_submission) && $wealthfinance->application_submission == 'Progress' ? 'selected' : '' }}>Progress</option>
                                                        <option
                                                            value="Done"{{ isset($wealthfinance->application_submission) && $wealthfinance->application_submission == 'Done' ? 'selected' : '' }}>Done</option>
                                                ...
                                                <div class="formAreahalf basic_data">
                                                    ...
                                                    <select name="account_type" id="account_type" class="form-control">
                                                        ...
                                                        <option value="SGD"
                                                            {{ isset($wealthfinance->account_type) && $wealthfinance->account_type == 'SGD' ? 'selected' : '' }}>
                                                            SGD</option>
                                                        <option value="USD"
                                                            {{ isset($wealthfinance->account_type) && $wealthfinance->account_type == 'USD' ? 'selected' : '' }}>
                                                            USD</option>
                                                        <option value="Multi-currency"
                                                            {{ isset($wealthfinance->account_type) && $wealthfinance->account_type == 'Multi-currency' ? 'selected' : '' }}>
                                                            Multi-currency</option>
                                                        <option value="Others"
                                                            {{ isset($wealthfinance->account_type) && $wealthfinance->account_type == 'Others' ? 'selected' : '' }}>
                                                            Others</option>
                                                    </select>
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                    ...
                                                    <input type="text" name="account_policy_no" id="account_policy_no"
                                                        value="@isset($wealthfinance->account_policy_no)  {{ $wealthfinance->account_policy_no }} @endisset"
                                                        class="form-control">
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                    <label for="account_opening_status" class="form-label">Account
                                                        Opening
                                                        Status</label>
                                                    <select name="account_opening_status" id="account_opening_status"
                                                        class="js-example-responsive form-control">
                                                        <option value="" selected disabled>Choose account opening
                                                            status
                                                        </option>
                                                        <option value="Pending"
                                                            {{ isset($wealthfinance->account_opening_status) && $wealthfinance->account_opening_status == 'Pending' ? 'selected' : '' }}>Pending</option>
                                                        <option value="Approved"
                                                            {{ isset($wealthfinance->account_opening_status) && $wealthfinance->account_opening_status == 'Approved' ? 'selected' : '' }}>Approved</option>
                                                        <option value="Rejected"
                                                            {{ isset($wealthfinance->account_opening_status) && $wealthfinance->account_opening_status == 'Rejected' ? 'selected' : '' }}>Rejected</option>
                                                ...
                                                <div class="formAreahalf basic_data">
                                                    <label for="current_account_status" class="form-label">Current
                                                        Account
                                                        Status</label>
                                                    <select name="current_account_status" id="current_account_status"
                                                        class="js-example-responsive form-control">
                                                        <option value="" selected disabled>Choose account status
                                                        </option>
                                                        <option value="Pending"
                                                            {{ isset($wealthfinance->current_account_status) && $wealthfinance->current_account_status == 'Pending' ? 'selected' : '' }}>Pending</option>
                                                        <option value="Approved"
                                                            {{ isset($wealthfinance->current_account_status) && $wealthfinance->current_account_status == 'Approved' ? 'selected' : '' }}>Approved</option>
                                                        <option value="Rejected"
                                                            {{ isset($wealthfinance->current_account_status) && $wealthfinance->current_account_status == 'Rejected' ? 'selected' : '' }}>Rejected</option>
                                                    </select>
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                    <label for="money_deposit_status" class="form-label">Money Deposit
                                                        Status</label>
                                                    <select name="money_deposit_status" id="money_deposit_status"
                                                        class="js-example-responsive form-control">
                                                        <option value="" selected disabled>Choose money deposit
                                                            status
                                                        </option>
                                                        <option value="Progress"
                                                            {{ isset($wealthfinance->money_deposit_status) && $wealthfinance->money_deposit_status == 'Progress' ? 'selected' : '' }}>Progress</option>
                                                        <option value="Done"
                                                            {{ isset($wealthfinance->money_deposit_status) && $wealthfinance->money_deposit_status == 'Done' ? 'selected' : '' }}>Done</option>
                                                        <option value="N/A"
                                                            {{ isset($wealthfinance->money_deposit_status) && $wealthfinance->money_deposit_status == 'N/A' ? 'selected' : '' }}>N/A</option>
                                                    </select>
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                    ...
                                                    <div class="dollersec"><span class="doller">$</span>
                                                        <span class="input"> <input type="text"
                                                                name="intial_deposit_amount"
                                                                value="@isset($wealthfinance->intial_deposit_amount) {{ $wealthfinance->intial_deposit_amount }} @endisset"
                                                ...
                                                <div class="formAreahalf basic_data">
                                                    <label for="online_account_username" class="form-label">Online
                                                        Account
                                                        Login</label>
                                                    <input type="text" name="online_account_username"
                                                        id="online_account_username"
                                                        value="@isset($wealthfinance->online_account_username) {{ $wealthfinance->online_account_username }} @endisset"
                                                        class="form-control">
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                    <label for="online_account_pass" class="form-label">Online Account
                                                        Password</label>
                                                    <input type="text" name="online_account_pass"
                                                        id="online_account_pass"
                                                        value="@isset($wealthfinance->online_account_pass) {{ $wealthfinance->online_account_pass }} @endisset"
                                                        class="form-control">
                                                </div>
                                                <div class="formAreahalf basic_data">
                                                    <label for="finacial_remarks" class="form-label">Remarks</label>
                                                    <textarea name="finacial_remarks" id="finacial_remarks" rows="4" cols="50"
                                                        value="@isset($wealthfinance->finacial_remarks) {{ $wealthfinance->finacial_remarks }} @endisset"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="lower-bottom">
                ...
                <form action="javascript:void(0)" method="POST" name="notes" id="notes" class="note_send">
                    ...
                    <div class="textarea">
                        ...
                        <input type="submit" id="w_notessave_btn"
                            class="btn saveBtn btn saveBtn btn_notes disabled-btn" value="Save">
                    </div>
                </form>
                @foreach ($notes as $note)
                    <div class="notes_show">
                        <p class="desc_notes">{{ $note->notes_description }}</p>
                        <p class="created">{{ $note->created_atsetTimezone('Asia/Singapore')->format('j F Y  g:i a') }}</p>
            ...
            <div class="card file upload company_file_upload_info formContentData border-0 p-4 ">
                <h3>File Uploads</h3>
                <form action="javascript:void(0)" method="POST" id="file_wealt_upload"
                    ...
                    <div class="mb-3">
                        <input type="file" name="file" placeholder="Choose File" id="wealth_inputFile"
                            class="form-control">
