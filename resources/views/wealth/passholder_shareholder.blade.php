                                                ...
                                                <div class="tab-inner-text d-flex flex-wrap">
                                                    <div class="formAreahalf basic_data">
                                                        <label for="tin_country_before_app" class="form-label">Current TIN Country</label>
                                                    ...
                                                    <div class="formAreahalf basic_data">
                                                        <label for="type_of_tin_before_app" class="form-label">Type of TIN</label>
                                                    ...
                                                    <div class="formAreahalf basic_data">
                                                        <label for="tin_no_before_pass_app" class="form-label">Current TIN Number</label>
                                                    ...
                                                    <div class="formAreahalf basic_data">
                                                        <label for="pass_app_status" class="form-label">Pass Application
                                                            Status</label>
                                                        <select name="passholder[{{$passholder_key}}][pass_app_status]" 
                                                    ...
                                                    <div class="formAreahalf basic_data">
                                                        <label for="pass_app_type" class="form-label">Pass Application
                                                            Type</label>
                                                        <select name="passholder[{{$passholder_key}}][pass_app_type]" 
                                                            class="js-example-responsive form-control">
                                                    ...
                                                    <div class="formAreahalf basic_data">
                                                        <label for="pass_inssuance" class="form-label">Pass
                                                            Issuance</label>
                                                        <select name="passholder[{{$passholder_key}}][pass_inssuance]" 
                                                            class="js-example-responsive form-control">
